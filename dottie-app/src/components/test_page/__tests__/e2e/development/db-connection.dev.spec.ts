...
// Development test suite for the SQLite database connection
test.describe('Development - SQLite Database Connection Tests', () => {
  ...
  test('should display SQLite section with correct button state', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(screenshotDir, 'dev-sqlite-initial-state.png') });
    ...
    await page.screenshot({ path: path.join(screenshotDir, 'dev-sqlite-section.png') });
  });
  ...
  test('should show error message when SQLite connection fails in development', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(screenshotDir, 'dev-sqlite-connection-error.png') });
  });
  ...
  test('should show success message when SQLite connection succeeds in development', async ({ page }) => {
    ...
    await page.screenshot({ path: path.join(screenshotDir, 'dev-sqlite-connection-success.png') });
  });
}); 